...
data_sample = PandasParameterType(pd.DataFrame({"S": pd.Series(["example_value"], dtype="object"), "M": pd.Series([0.0], dtype="float32"), "Q": pd.Series([0.0], dtype="float32"), "H": pd.Series([0.0], dtype="float32"), "Y": pd.Series([0.0], dtype="float32"), "D": pd.Series([0.0], dtype="float32"), "MO": pd.Series([0.0], dtype="float32"), "W": pd.Series([0.0], dtype="float32"), "R": pd.Series([0.0], dtype="float32"), "SX": pd.Series([0.0], dtype="float32"), "SP": pd.Series([0.0], dtype="float32")}))
